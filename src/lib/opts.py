...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--vis_thresh', type=float, default=0.09,  # 0.3
        ...
        self.parser.add_argument('--scale', type=float, default=0,  #0.4
                                 help='when not using random crop'
                                      'apply scale augmentation.')
        self.parser.add_argument('--rotate', type=float, default=45, #0
                                 help='when not using random crop'
        ...
        self.parser.add_argument('--aug_rot', type=float, default=0.5, #0
        ...
        # More option
        self.parser.add_argument('--center_thresh', type=float, default=0.15, #0.3
        ...
        self.parser.add_argument('--ford', default=True)
        self.parser.add_argument('--green_background', default=False)
        ...
        default_dataset_info = {
            'object_pose': {
               'default_resolution': [512, 512],
                ...
                # 'default_resolution': [5472, 3648],  # ford video resolution
                'num_classes': 1,
